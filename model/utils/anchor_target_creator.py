...
class AnchorTargetCreator(object):
    ...
    def make_anchor_target(self, anchor, gt_bbox, image_size):
        ...
        n_anchor = len(anchor)
        #this is to remove the anchors that are outside the image of size 600X800
        ...
        # create targer delta for bbox regression (here bounding box delta will be defined for the respective groundtruth
        #(cont)  higher iou with anchor(bbox_index_for_anchor)
        #  convert it into this format : Δ​x​center​​​​, Δ​y​center​​​​, Δ​width​​, Δ​height​​,
